...
Then, in the terminal or command line, run:
  python builds/build3_hitl_router_agent.py --data data/qac387_data.csv --report_dir reports --tags build3 --memory
...
def do_tool_run_from_plan(
    *,
    ...
    summary = traced_summarize(summarize_chain, req, res.text[:50000], base_config, tags)
